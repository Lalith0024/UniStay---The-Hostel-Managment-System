...
router.post('/', async (req, res) => {
  try {
    ...
    const students = await Student.create([
      { name: 'Rahul Sharma', email: 'rahul@test.com', password: '123', room: '101', block: 'A', status: 'Active', department: 'CSE', year: '3rd', image: 'https://randomuser.me/api/portraits/men/32.jpg' },
      { name: 'Priya Patel', email: 'priya@test.com', password: '123', room: '102', block: 'A', status: 'Active', department: 'ECE', year: '2nd', image: 'https://randomuser.me/api/portraits/women/44.jpg' },
      { name: 'Amit Kumar', email: 'amit@test.com', password: '123', room: '103', block: 'B', status: 'Inactive', department: 'MECH', year: '4th', image: 'https://randomuser.me/api/portraits/men/22.jpg' },
      { name: 'Sneha Gupta', email: 'sneha@test.com', password: '123', room: '104', block: 'A', status: 'Active', department: 'CSE', year: '1st', image: 'https://randomuser.me/api/portraits/women/68.jpg' },
      { name: 'Vikram Singh', email: 'vikram@test.com', password: '123', room: '105', block: 'B', status: 'Active', department: 'CIVIL', year: '3rd', image: 'https://randomuser.me/api/portraits/men/46.jpg' },
      { name: 'Anjali Rai', email: 'anjali@test.com', password: '123', room: '106', block: 'A', status: 'Active', department: 'ECE', year: '2nd', image: 'https://randomuser.me/api/portraits/women/65.jpg' },
      { name: 'Rohit Verma', email: 'rohit@test.com', password: '123', room: '107', block: 'B', status: 'Active', department: 'CSE', year: '4th', image: 'https://randomuser.me/api/portraits/men/54.jpg' },
      { name: 'Neha Jain', email: 'neha@test.com', password: '123', room: '108', block: 'A', status: 'Inactive', department: 'MECH', year: '1st', image: 'https://randomuser.me/api/portraits/women/26.jpg' },
      { name: 'Karan Malhotra', email: 'karan@test.com', password: '123', room: '109', block: 'B', status: 'Active', department: 'CIVIL', year: '3rd', image: 'https://randomuser.me/api/portraits/men/12.jpg' },
      { name: 'Simran Kaur', email: 'simran@test.com', password: '123', room: '110', block: 'A', status: 'Active', department: 'CSE', year: '2nd', image: 'https://randomuser.me/api/portraits/women/90.jpg' },
      { name: 'Arjun Das', email: 'arjun@test.com', password: '123', room: '111', block: 'B', status: 'Active', department: 'ECE', year: '4th', image: 'https://randomuser.me/api/portraits/men/85.jpg' },
      { name: 'Meera Reddy', email: 'meera@test.com', password: '123', room: '112', block: 'A', status: 'Active', department: 'MECH', year: '1st', image: 'https://randomuser.me/api/portraits/women/62.jpg' }
    ]);
